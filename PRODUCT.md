...
## Users
- **Primary**: Founders and operators of Kenyan SMEs (10–200 employees) who need custom software or AI automation and are doing preliminary research.
- **Secondary**: Established companies seeking specialist engineering capability without enterprise procurement timelines.
- **Tertiary**: Potential hires evaluating whether NorthBit is worth applying to.

## Brand Voice
Direct, honest, technically confident. "Operators" not "clients". No pitch-deck fluff. Backs every claim with a concrete detail. Never oversells. Short paragraphs, no passive voice.
...
- Generic agency sites that list services without proof
...
- Clients: Magena Pilates (magenapilates.com), Premier Beauty Clinic (premierbeautyclinic.vercel.app), S.Socials (ssocials.co)

## Pages (7)
`/` Home · `/services` · `/industries` · `/work` · `/about` · `/careers` · `/contact`
